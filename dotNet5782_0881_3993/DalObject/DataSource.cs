...
namespace Dal
{
    static class DataSource
    {
        ...
        public static void Initialize()
        {
            ...
            BaseStations.Add(new BaseStationDal() { Id = 100, Name = "Herzliya", Latitude = 32.164, Longitude = 34.842, FreeChargeSlots = rand.Next(0, 10) });
            BaseStations.Add(new BaseStationDal() { Id = 200, Name = "Tel Aviv", Latitude = 32.056, Longitude = 34.779, FreeChargeSlots = rand.Next(0, 10) });
